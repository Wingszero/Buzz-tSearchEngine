...
//            "compute-1.amazonaws.com:9000"; // distributed mode
    ...
    private static String PAGERANK_PATH;

    private static boolean RECOMPUTE;

    private static ConfigLoader configLoader = null;

    public static String getPagerankPath() {
        init();
        return PAGERANK_PATH;
    }
    ...
    private ConfigLoader() {
        try {
            ...
            PAGERANK_PATH = in.readLine();
            System.out.println("Pagerank: " + PAGERANK_PATH);
